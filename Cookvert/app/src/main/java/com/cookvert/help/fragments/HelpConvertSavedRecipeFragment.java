...
public class HelpConvertSavedRecipeFragment extends Fragment{
    ...
    public static HelpConvertSavedRecipeFragment newInstance(){
        return new HelpConvertSavedRecipeFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final LinearLayout layout = (LinearLayout) inflater.inflate(
                R.layout.fragment_help_convert_saved_recipe, container, false);
        ...
        String content4bold = getActivity().getResources().getString(
                R.string.help_convert_saved_recipe_content_4part1_bold);
        String content4after = getActivity().getResources().getString(
                R.string.help_convert_saved_recipe_content_4part2);
