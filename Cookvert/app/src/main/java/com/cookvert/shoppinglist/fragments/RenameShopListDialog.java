 ...
 * {@link RenameShopListDialog.OnRenameShopListListener} interface
 * to handle interaction events.
 */
public class RenameShopListDialog extends DialogFragment {

    private OnRenameShopListListener mListener;
    private static final String ARG_NAME = "shopListName";

    public RenameShopListDialog() {
        // Required empty public constructor
    }

    public static RenameShopListDialog newInstance(String name){
        RenameShopListDialog fragment = new RenameShopListDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.title_dialog_rename_shop_list);
        ...
        builder.setNegativeButton(R.string.all_cancel, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                RenameShopListDialog.this.getDialog().cancel();
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnRenameShopListListener) {
            mListener = (OnRenameShopListListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnRenameShopListListener");
        }
    }
    ...
    class CorrectInputListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if (iName.getText().toString().length() == 0) {
                ...
                mListener.onRenameShopList(iName.getText().toString());
                dialog.dismiss();
            }
        }
    }
     ...
     */
    public interface OnRenameShopListListener{
        void onRenameShopList(String name);
    }
}
